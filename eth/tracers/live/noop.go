...
func (t *noop) OnOpcode(pc uint64, section uint64, op byte, gas, cost uint64, scope tracing.OpContext, rData []byte, depth int, functiondepth uint64, err error) {
}

func (t *noop) OnFault(pc uint64, section uint64, op byte, gas, cost uint64, _ tracing.OpContext, depth int, functondepth uint64, err error) {
}
